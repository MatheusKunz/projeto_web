...
<div class="conteiner">
    ...
    <form action="../Services/processaEdicao.php" method="post">
        ...
        <input type="text" id="marca" name="marca" value="<?= htmlspecialchars($carro->getMarca()) ?>" required><br><br>

        <label for="modelo">Modelo:</label><br>
        <input type="text" id="modelo" name="modelo" value="<?= htmlspecialchars($carro->getModelo()) ?>" required><br><br>
        ...
        <input type="text" id="placa" name="placa" value="<?= htmlspecialchars($carro->getPlaca()) ?>" required><br><br>

        <label for="preco">Preço:</label><br>
        <input type="text" id="preco" name="preco" value="<?= htmlspecialchars($carro->getPreco()) ?>" required><br><br>
